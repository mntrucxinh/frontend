  ...
  return (
    <header className='sticky top-0 z-50'>
      ...
      <div className='relative w-full overflow-hidden bg-[#F78F1E] py-2.5 shadow-sm'>
        ...
        <div className='relative container mx-auto flex flex-col gap-3 px-4 md:flex-row md:items-center md:justify-between md:gap-4'>
          {/* Contact Info - Pill Style */}
          <div className='flex flex-wrap items-center gap-2.5 md:gap-3'>
            <a
              href={`mailto:${CONTACT_INFO.email}`}
              className='group relative inline-flex items-center gap-2 rounded-full bg-white px-3.5 py-1.5 text-xs font-medium text-[#33B54A] shadow-sm transition-all hover:shadow-md hover:scale-105 active:scale-95 md:px-4 md:py-2 md:text-sm'
            >
              <div className='flex size-6 items-center justify-center rounded-full bg-[#33B54A]/10 text-[#33B54A] transition-all group-hover:bg-[#33B54A]/20 group-hover:scale-110 md:size-7'>
          ...
          <div className='hidden items-center gap-3 md:flex'>
            ...
            <div className='flex items-center gap-2 rounded-full bg-white px-2 py-1.5 shadow-sm md:gap-2.5 md:px-3'>
              <a
                href='#'
                className='group relative flex size-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-md transition-all hover:scale-110 hover:shadow-lg hover:from-blue-600 hover:to-blue-700 active:scale-95 md:size-9'
                aria-label='Facebook'
              >
              ...
              <a
                href='#'
                className='group relative flex size-8 items-center justify-center rounded-full bg-gradient-to-br from-red-500 to-red-600 text-white shadow-md transition-all hover:scale-110 hover:shadow-lg hover:from-red-600 hover:to-red-700 active:scale-95 md:size-9'
                aria-label='YouTube'
              >
              ...
              <a
                href='#'
                className='group relative flex size-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-400 to-blue-500 text-white shadow-md transition-all hover:scale-110 hover:shadow-lg hover:from-blue-500 hover:to-blue-600 active:scale-95 md:size-9'
                aria-label='Zalo'
              >
            ...
            {NAV_ITEMS.map((item) => {
              if (!item.children?.length) {
                return (
                  <button
                    ...
                    className='relative pb-1.5 transition-all duration-300 hover:text-[#33B54A] after:absolute after:bottom-0 after:left-0 after:h-[3px] after:w-0 after:rounded-full after:bg-gradient-to-r after:from-[#33B54A] after:to-[#F78F1E] after:transition-all after:duration-300 hover:after:w-full'
                  >
                    {item.label}
                  </button>
                )
              ...
              return (
                <div key={item.label} className='group relative'>
                  ...
                  {/* Dropdown */}
                  <div className='invisible absolute left-0 top-full mt-2 w-64 translate-y-2 rounded-2xl bg-white shadow-2xl ring-1 ring-[#33B54A]/20 opacity-0 transition-all duration-300 ease-out group-hover:visible group-hover:translate-y-0 group-hover:opacity-100'>
                    <div className='py-2'>
                      {item.children.map((c) => (
                        <button
                          key={c.label}
                          onClick={() => router.push(c.href)}
                          className='block w-full text-left px-5 py-2.5 text-[15px] text-primary transition-all duration-200 hover:bg-gradient-to-r hover:from-[#33B54A]/10 hover:to-[#F78F1E]/10 hover:text-[#33B54A] hover:pl-6'
                        >
                          {c.label}
                        </button>
                      ))}
                  ...
                  if (!hasChildren) {
                    return (
                      <button
                        ...
                        className='w-full text-left rounded-xl p-3.5 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#33B54A]/10 hover:to-[#F78F1E]/10 hover:text-[#33B54A] active:scale-98'
                      >
                        {item.label}
                      </button>
                    )
                  ...
                  return (
                    <div key={item.label} className='rounded-xl'>
                      <button
                        ...
                        className='flex w-full items-center justify-between rounded-xl p-3.5 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#33B54A]/10 hover:to-[#F78F1E]/10 hover:text-[#33B54A] active:scale-98'
                        ...
                        <div className='pb-2 pl-4'>
                          {item.children!.map((c) => (
                            <button
                              ...
                              className='block w-full text-left rounded-lg px-4 py-2.5 text-[14px] text-primary transition-all duration-200 hover:bg-[#33B54A]/10 hover:text-[#33B54A] hover:pl-5 active:scale-98'
                            >
                              {c.label}
                            </button>
                          ))}
