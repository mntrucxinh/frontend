    ...
    >
      ...
      >
        <div className='flex items-center justify-between border-b px-4 py-3'>
          <div className='line-clamp-1 font-bold text-slate-800'>{title}</div>
          <button
            type='button'
            onClick={onClose}
...
export default function FeaturedActivities() {
  ...
  return (
    <>
      ...
      >
        {/* doodle góc phải */}
        <div className='pointer-events-none absolute right-6 top-6 hidden opacity-40 md:block'>
        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='mx-auto mt-10 grid max-w-6xl grid-cols-1 gap-8 md:mt-12 md:grid-cols-2 md:gap-10 lg:grid-cols-3'>
              ...
              {videos.map((v) => (
                ...
                >
                  ...
                  <button
                    type='button'
                    onClick={() => onOpen(v)}
                    className='relative h-[210px] w-full bg-slate-100'
                  ...
                  >
                    ...
                    <div className='absolute inset-0 flex items-center justify-center'>
                      <div className='flex size-12 items-center justify-center rounded-full bg-white shadow-sm'>
                        <Play className='ml-0.5 size-5 text-emerald-600' />
                      </div>
                    </div>
                  </button>
                  ...
                  {/* Nội dung */}
                  <div className='p-5'>
                    <div className='rounded-xl bg-slate-50 px-3 py-2 text-xs text-slate-500 md:text-sm'>
                      Ngày đăng: {v.dateText}
                    </div>

                    <h3
                      className='mt-3 line-clamp-2 text-[15px] font-bold leading-snug text-emerald-600 md:text-base'
                      style={{ fontFamily: "'Baloo 2', system-ui, sans-serif" }}
                    >
                      {v.title}
                    </h3>
