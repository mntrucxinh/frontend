          ...
          <div className='mx-auto grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-2 md:items-stretch'>
            ...
            >
              ...
              <div className='relative flex flex-1 flex-col p-8'>
                ...
                <p className='mb-6 flex-1 text-justify text-base leading-relaxed text-white/95 md:text-lg'>
                  Xây dựng môi trường giáo dục lấy trẻ làm trung tâm, thực hiện Chương trình Giáo
                  dục Mầm non của Bộ GD&ĐT, tích hợp STEAM, giáo dục trải nghiệm, kỹ năng sống và
                  phát triển năng khiếu phù hợp với từng độ tuổi.
                </p>
            ...
            >
              ...
              <div className='relative flex flex-1 flex-col p-8'>
                ...
                <p className='mb-6 flex-1 text-justify text-base leading-relaxed text-white/95 md:text-lg'>
                  Nuôi dưỡng tối đa năng lực cá nhân của trẻ thông qua các hoạt động nghệ thuật,
                  biểu diễn sân khấu, trải nghiệm thiên nhiên, rèn luyện kỹ năng xã hội, tư duy khoa
                  học – công nghệ và khả năng hợp tác, giải quyết vấn đề.
                </p>
          ...
          <div className='mx-auto grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-2 md:items-stretch'>
            ...
            >
              ...
              <div className='relative flex flex-1 flex-col p-8'>
                ...
                <p className='mb-6 flex-1 text-justify text-base leading-relaxed text-white/95 md:text-lg'>
                  Hướng đến trở thành trường mầm non uy tín, bền vững tại Đà Nẵng, được phụ huynh
                  tin chọn bởi chất lượng chăm sóc – giáo dục ổn định, môi trường an toàn, giàu trải
                  nghiệm và khả năng phát hiện – bồi dưỡng năng lực riêng của mỗi trẻ.
                </p>
