  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center px-4">
      <div className="absolute inset-0 animate-[fadeIn_0.4s_ease-out] bg-gradient-to-br from-emerald-50 via-green-50 to-lime-100">
        <div className="absolute -right-16 -top-24 h-72 w-72 rounded-full bg-emerald-300/40 blur-3xl" />
        <div className="absolute -bottom-24 -left-10 h-72 w-72 rounded-full bg-lime-300/40 blur-3xl" />
      ...
      >
        <div className="mx-auto flex h-12 w-12 items-center justify-center">
          <div className="relative h-12 w-12">
            ...
            <div className="absolute inset-0 m-auto h-2.5 w-2.5 rounded-full bg-emerald-500" />
          </div>
        </div>
